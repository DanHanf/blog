...
encryptor.decryptFile(__dirname+'/../secrets/emails.dat', __dirname+'/../secrets/emailList.csv', key, function(err) {
  ...
  fs.readFile(__dirname+'/../secrets/emailList.csv', 'utf8', function(err, data) {
    ...
    transporter.sendMail({
      ...
      html: "<b>Here's your daily dose of Steal My Sunshine by Len!</b> <br /><br /> <a href='https://youtu.be/E1fzJ_AYajA'>Have a conqueror's day</a>,<br /><br />Your Daily Len<br /><br /> <br /><a href ='http://xoxodan.com/dailyLenUnsub'>Click here</a> to unsubscribe."
